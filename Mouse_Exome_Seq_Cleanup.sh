...
gunzip TMCK1-23B_filtered.vcf.gz 
...
awk '/^#/{print}' TMCK1-23B_filtered.vcf >> TMCK1-23B_filtered_clean.vcf
awk '/^[^#]/{ if ($7 == "PASS") {print} }' TMCK1-23B_filtered.vcf >> TMCK1-23B_filtered_clean.vcf
